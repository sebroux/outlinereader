...
/*
 * Extrait les propriétés de l'outline
 * List outline properties
 *
 * Version : 1.2 (27 juillet 2010)
 * Author : Sébastien Roux
 * Email : roux.sebastien@gmail.com
 *
 * Disclaimer : you may freely use, reuse, modify 
 * and distribute the following code at your own risks.
 */
public class ReadOutline {
    ...
    public static void setEssProvider(String essPwd) {
        if (essProvider == null) {
            ...
            ReadOutline.essProvider = "http://" + getEssSvr() + ":13080/aps/JAPI";
        } else {
            ReadOutline.essProvider = essProvider;
        }
    }
    ...
    public static void setDimension(String dimension) {
        ReadOutline.dimension = dimension;
    }
    ...
    public static void setDelimiter(String delimiter) {
        ReadOutline.delimiter = delimiter;
    }
